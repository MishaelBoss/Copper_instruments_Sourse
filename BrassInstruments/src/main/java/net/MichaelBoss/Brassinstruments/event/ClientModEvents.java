...
public class ClientModEvents {
    ...
    public static void onBlockClick(PlayerInteractEvent event) {
        ...
        if(level.isRaining()){
            if(player.getMainHandItem().getItem() == ModItems.COPPER_SWORD.get()
                    || player.getMainHandItem().getItem() == ModItems.COPPER_PICKAXE.get()
                    || player.getMainHandItem().getItem() == ModItems.COPPER_AXE.get()
                    || player.getMainHandItem().getItem() == ModItems.COPPER_SHOVEL.get()
                    || player.getMainHandItem().getItem() == ModItems.COPPER_HOE.get()){
